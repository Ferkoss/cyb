    ...
    return (
        <div className="container-select">
            ...
            <div className="content-select">
                {data.map((x, i) => <AdminViewProduct key={x.id} handler={() => { handlerSoftDeleteProduct(x) }} name={x.subCategory + "/" + x.productNumber} category={x.category} size={x.size} price={x.price} img={insertImage({ subCategory: x.subCategory, productNumber: x.productNumber })} />)}
            </div>
        </div>
    )
}
